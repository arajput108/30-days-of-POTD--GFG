// 266.) Given a connected undirected graph represented by adjacency list, adjList[][] with n nodes, 
//       having a distinct label from 0 to n-1, where each adj[i] represents the list of vertices 
...
//     neighbors: List[Node]
// }
// Your task is to complete the function cloneGraph( ) which takes a starting node of the graph as input 
// and returns the copy of the given node as a reference to the cloned graph.

// Note: If you return a correct copy of the given graph, then the driver code will print true; and if an 
// incorrect copy is generated or when you return the original node, the driver code will print false.
